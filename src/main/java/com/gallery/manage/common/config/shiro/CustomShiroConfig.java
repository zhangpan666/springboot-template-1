...
public class CustomShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(DefaultWebSecurityManager defaultWebSecurityManager, ShiroUserFilter
        ...
        shiroFilterFactoryBean.setLoginUrl("/shortVideo/admin/auth/toLogin");
        shiroFilterFactoryBean.setSuccessUrl("/shortVideo/admin/index");
        shiroFilterFactoryBean.setUnauthorizedUrl("/shortVideo/admin/auth/403");
