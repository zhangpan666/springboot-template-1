...
public class ProjectConstant {
    ...
    public static final String APP_API_PREFIX = "/shortVideo/api/app";

    public static final String H5_API_PREFIX = "/shortVideo/api/h5";

    public static final String OPEN_API_PREFIX = "/shortVideo/api/open/";

    public static final String API_PREFIX = "/shortVideo/api/";

    public static final String ADMIN_PREFIX = "/shortVideo/admin/";
